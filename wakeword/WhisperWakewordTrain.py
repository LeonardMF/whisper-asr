...
# eigene Audiodaten einlesen
common_voice = DatasetDict()
common_voice["train"] = audioTrainDataset
common_voice["test"] = audioTestDataset

# deutschen Common-Voice Datenset von Huggingface einlesen
# common_voice = DatasetDict()
...
# Token-IDs aus Modell holen

tokenizer = WhisperTokenizer.from_pretrained("openai/whisper-tiny", language="german", task="transcribe")


# Kombination aus FeatureExtractor und Tokenizer

processor = WhisperProcessor.from_pretrained("openai/whisper-tiny", language="german", task="transcribe")


# erster Datensatz ausgeben

# print(common_voice["train"][0])

# auf 16 KHz samplen
# TODO: wird beim lokalen Datenset
# common_voice = common_voice.cast_column("audio", Audio(sampling_rate=16000))

print(common_voice["train"][0])


# Funktion zur Aufbereitung der Daten
